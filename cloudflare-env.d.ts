/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: fc17a2f27f38258e4de0e92da1863075)
// Runtime types generated with workerd@1.20251210.0 2025-12-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.open-next/worker-with-do");
		durableNamespaces: "UserPresenceDO" | "ChatRoomDO";
	}
	interface Env {
		DATABASE_URL: string;
		...
		WORKER_SELF_REFERENCE: Service<typeof import("./.open-next/worker-with-do").default>;
